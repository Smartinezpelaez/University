                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "University.API").Description("El proyecto de muestra es una aplicación construida en .NET Framework " +
                        ...
                        .Contact(x=> x.Name("Steven Martinez").Email("Smartinezpelaez@gmail.com"));
                        ...
                        c.ApiKey("Authorization")
                            .Description("Introdue el Token JWT aqui.")
                            .Name("Bearer")
                            .In("header");
                        //
                        //c.OAuth2("oauth2")
